...
const OrderHistoryDetail = () => {
  ...
  return (
    <div className="p-6 font-sans">
      <h1 className="text-2xl font-bold mb-4 pl-4 text-orange-600">Thông tin đơn hàng #{order.orderId || orderId}</h1>
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="mt-4 flex space-x-4">
          <button
            className="px-6 py-2 bg-white-500 border border-black text-black rounded-full hover:bg-orange-100"
            onClick={() => alert('Liên hệ hỗ trợ')}
          >
            Cần hỗ trợ
          </button>
          <button
            className="px-6 py-2 bg-black text-white rounded-full hover:bg-orange-200"
      ...
      <div className="bg-gray-100 border border-orange-500 rounded-xl p-2 mt-6">
